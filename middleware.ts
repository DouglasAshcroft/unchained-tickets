...
export function middleware(request: NextRequest) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://unchainedtickets.com http://localhost:3000 http://localhost:3001 https://api.coinbase.com https://*.coinbase.com https://eth.merkle.io https://cca-lite.coinbase.com https://mainnet.base.org https://sepolia.base.org wss://ws-feed.exchange.coinbase.com wss://www.walletlink.org",
